...
appointmentsRouter.get("/", function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var appointsRepository, appointments;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                appointsRepository = typeorm_1.getCustomRepository(AppointmentsRepository_1.default);
                return [4 /*yield*/, appointsRepository.find()];
            case 1:
