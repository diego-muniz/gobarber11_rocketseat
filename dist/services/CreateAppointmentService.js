...
var CreateAppointmentService = /** @class */ (function () {
    ...
    CreateAppointmentService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var appointmentsRepositoy, appointmentDate, findAppointmentInSameDate, appointment;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        appointmentsRepositoy = typeorm_1.getCustomRepository(AppointmentsRepository_1.default);
                        appointmentDate = date_fns_1.startOfHour(date);
                        return [4 /*yield*/, appointmentsRepositoy.findByDate(appointmentDate)];
                    case 1:
                        findAppointmentInSameDate = _b.sent();
                        if (findAppointmentInSameDate) {
                            throw Error("This appointment is already booked");
                        }
                        appointment = appointmentsRepositoy.create({
                            provider_id: provider_id,
                            date: appointmentDate,
                        });
                        return [4 /*yield*/, appointmentsRepositoy.save(appointment)];
                    case 2:
                        _b.sent();
